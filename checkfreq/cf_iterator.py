...
class CFIterator:
    def __init__(
        ...
        self._max_steps_per_epoch = int(math.ceil(len(self._dataloader._dataset) / self._batch_size))
        ...
        print(
            f"Epoch={self._epoch}, this ep steps={self._steps_this_epoch}, max_steps={self._max_steps_per_epoch}, total_steps={self._total_steps}, steps_to_run = {self._steps_to_run}"
        )
